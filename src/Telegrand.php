...
use Praskovi04\Telegrand\Client\TelegraphResponse;
use Praskovi04\Telegrand\Concerns\AnswersInlineQueries;
use Praskovi04\Telegrand\Concerns\CallTraitsMethods;
use Praskovi04\Telegrand\Concerns\ComposesMessages;
use Praskovi04\Telegrand\Concerns\CreatesScopedPayloads;
use Praskovi04\Telegrand\Concerns\HasBotsAndChats;
use Praskovi04\Telegrand\Concerns\InteractsWithCommands;
use Praskovi04\Telegrand\Concerns\InteractsWithTelegram;
use Praskovi04\Telegrand\Concerns\InteractsWithWebhooks;
use Praskovi04\Telegrand\Concerns\InteractWithUsers;
use Praskovi04\Telegrand\Concerns\ManagesKeyboards;
use Praskovi04\Telegrand\Concerns\SendsAttachments;
use Praskovi04\Telegrand\Concerns\StoresFiles;
...
class Telegrand
{
    ...
    public function dump(): Telegrand
    {
        dump($this->toArray());
